...
class SwappingAutoencoderOptimizer(BaseOptimizer):
    ...
    def prepare_images(self, data_i):
        return data_i["real_A_full"], data_i["real_A_feat_1"], data_i['real_A_feat_2'], data_i['real_A_feat_3'], data_i['real_A_feat_4'] , data_i['real_A_feat_5']  
    ...
    def train_one_step(self, data_i, total_steps_so_far):
        images_minibatch_full, images_minibatch_feat_1, images_minibatch_feat_2, images_minibatch_feat_3, images_minibatch_feat_4, images_minibatch_feat_5 = self.prepare_images(data_i)
        #images_minibatch_full, images_minibatch_feat_1, images_minibatch_feat_2, images_minibatch_feat_3, images_minibatch_feat_4 = self.prepare_images(data_i)
        if self.toggle_training_mode() == "generator":
            losses = self.train_discriminator_one_step(images_minibatch_full, images_minibatch_feat_1, images_minibatch_feat_2, images_minibatch_feat_3, images_minibatch_feat_4, images_minibatch_feat_5)
            #losses = self.train_discriminator_one_step(images_minibatch_full, images_minibatch_feat_1, images_minibatch_feat_2, images_minibatch_feat_3, images_minibatch_feat_4)
        else:
            losses = self.train_generator_one_step(images_minibatch_full, images_minibatch_feat_1, images_minibatch_feat_2, images_minibatch_feat_3, images_minibatch_feat_4, images_minibatch_feat_5)
            #losses = self.train_generator_one_step(images_minibatch_full, images_minibatch_feat_1, images_minibatch_feat_2, images_minibatch_feat_3, images_minibatch_feat_4)
        return util.to_numpy(losses)

    def train_generator_one_step(self, images_full, images_feat_1, images_feat_2, images_feat_3, images_feat_4, images_feat_5):
        self.set_requires_grad(self.Dparams, False)
        self.set_requires_grad(self.Gparams, True)
        sp_ma, gl_ma = None, None
        self.optimizer_G.zero_grad()
        g_losses, g_metrics = self.model(images_full, images_feat_1, images_feat_2, images_feat_3, images_feat_4, images_feat_5, sp_ma, gl_ma, command = "compute_generator_losses")
        #g_losses, g_metrics = self.model(images_full, images_feat_1, images_feat_2, images_feat_3, images_feat_4, sp_ma, gl_ma, command = "compute_generator_losses")
    ...
    def train_discriminator_one_step(self, images_full, images_feat_1, images_feat_2, images_feat_3, images_feat_4, images_feat_5):
        ...
        d_losses, d_metrics, sp, gl = self.model(images_full, images_feat_1, images_feat_2, images_feat_3, images_feat_4, images_feat_5, command = "compute_discriminator_losses")
        ...
        if needs_R1_at_current_iter:
            self.optimizer_D.zero_grad()
            r1_losses = self.model(images_full, images_feat_1, images_feat_2, images_feat_3, images_feat_4, images_feat_5, command="compute_R1_loss")
    ...
    def get_visuals_for_snapshot(self, data_i):
        images, _, _, _, _, _ = self.prepare_images(data_i)
        with torch.no_grad():
